...
impl Config {
    ...
    pub fn merge_with_args(&self, args: &crate::cli::Args) -> EffectiveConfig {
        ...
        let exit_on_error = if args.exit_on_error {
            true
        } else {
            self.exit_on_error.unwrap_or(false)
        };
...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            connectivity_ports: Some(vec![
                crate::networking::DEFAULT_PORTS[0],
                crate::networking::DEFAULT_PORTS[1],
                crate::networking::DEFAULT_PORTS[2],
            ]),
